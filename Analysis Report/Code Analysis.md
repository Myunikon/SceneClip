# Parabolic Analyzed Source Code

This document contains the full source code of the files analyzed during the reverse engineering process.

## 1. models/downloadoptions.cpp

(Handles argument generation, file extensions, and format selection)
