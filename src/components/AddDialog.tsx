...
import { Download, HardDrive, HelpCircle, X } from 'lucide-react'
                            ...
                            <div className="flex justify-between items-center p-6 border-t border-border dark:border-white/10 bg-muted/50 dark:bg-card/95 shrink-0 gap-4 z-20">
                                    ...
                                    {(estimatedSize || (meta?.formats)) && hasMeta && (
                                        <div className="flex flex-col animate-in fade-in slide-in-from-bottom-2">
                                            ...
                                            <div className="flex items-center gap-2 text-sm font-mono font-medium text-foreground overflow-hidden h-5">
                                                ...
                                                <span className="block min-w-[3ch]">
                                                    {formattedSize}
                                                </span>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button 
                                        ...
                                        disabled={!hasMeta || props.isOffline || (options.isClipping && !!options.rangeStart && !!options.rangeEnd && parseTime(options.rangeStart) >= parseTime(options.rangeEnd))} 
                                        className="relative isolate overflow-hidden group px-8 py-3.5 rounded-2xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center gap-2.5 transform active:scale-[0.98] bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 text-white shadow-xl shadow-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/50 hover:-translate-y-0.5 border border-white/20"
                                    >
