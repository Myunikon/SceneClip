  ...
  return (
    <div className="h-screen w-full flex flex-col text-foreground font-sans overflow-hidden selection:bg-primary/30 relative">
      ...
      {settings.lowPerformanceMode ? (
        showBanner && (
          <div className="absolute bottom-14 inset-x-0 z-50 flex justify-center pointer-events-none">
            <div className="pointer-events-auto flex items-center gap-3 px-5 py-3 rounded-full bg-white dark:bg-zinc-900 border border-red-500/30 shadow-lg text-red-600 dark:text-red-400 font-medium text-sm">
