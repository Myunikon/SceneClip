    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2">
            ...
            <section className="pt-8 pb-4 border-t border-dashed border-border/50 text-center space-y-4">
                ...
                <div className="flex justify-center gap-4 opacity-50 text-[10px] font-mono uppercase tracking-widest">
                ...
                <div className="max-w-xs mx-auto text-[10px] text-muted-foreground/50 text-center leading-tight">
