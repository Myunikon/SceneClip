                        ...
                        >
                            ...
                            <div className="flex justify-end gap-3 p-4 bg-muted/20 border-t border-border/50">
                                <Button
                                    ...
                                    className="h-auto px-4 py-1.5 rounded-md text-sm font-medium bg-secondary hover:bg-secondary/80 text-secondary-foreground transition-colors min-w-[80px]"
                                >
                                ...
                                <Button
                                    ...
                                    className="h-auto px-4 py-1.5 rounded-md text-sm font-medium bg-red-500 hover:bg-red-600 text-white shadow-sm transition-colors min-w-[80px]"
                                >
                                ...
                                <Tooltip>
                                    <TooltipTrigger asChild>
                                        <Button
                                            ...
                                            className="h-auto w-auto text-primary hover:bg-primary/10 p-1.5 rounded-md transition-colors"
                                        >
                                            <Plus className="w-4 h-4" />
                                        </Button>
                                    </TooltipTrigger>
                                    <TooltipContent>
                                        <p>{t('settings.security.add_new')}</p>
                                    </TooltipContent>
                                </Tooltip>
                            </TooltipProvider>
                        )}
                        ...
                        >
                            <div className="bg-secondary/30 rounded-xl border border-border/50 p-4 space-y-4">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    <Button variant="ghost" onClick={cancelEdit} className="h-auto w-auto text-muted-foreground hover:text-foreground p-1 rounded-md hover:bg-background/50 transition-colors">
                                        <X className="w-4 h-4" />
                                    </Button>
                                </div>
                                ...
                                <div className="flex justify-end pt-2">
                                    <Button
                                        ...
                                        className="h-auto bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-primary-foreground px-6 py-2 rounded-lg text-sm font-medium shadow-sm flex items-center gap-2 transition-all active:scale-95"
                                    >
                                        {isSubmitting ? (
                                            <>
                    ...
                    {(!settings.savedCredentials || settings.savedCredentials.length === 0) && !isAdding && (
                        <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground">
                            ...
                            <Button
                                variant="ghost"
                                onClick={() => setIsAdding(true)}
                                className="h-auto text-xs bg-primary/10 text-primary hover:bg-primary/20 px-4 py-2 rounded-full font-medium transition-colors"
                            >
                                            ...
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <Button
                                                        ...
                                                        className="h-auto w-auto opacity-0 group-hover:opacity-100 p-0.5 hover:bg-muted rounded transition-all text-muted-foreground hover:text-foreground"
                                                    >
                                    ...
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Button
                                                ...
                                                className="h-auto w-auto p-1.5 hover:bg-primary/10 text-muted-foreground hover:text-primary rounded-md transition-colors"
                                            >
                                                <Edit2 className="w-4 h-4" />
                                            </Button>
                                        </TooltipTrigger>
                                        <TooltipContent>
                                            <p>{t('settings.security.edit_credential')}</p>
                                        </TooltipContent>
                                    </Tooltip>
                                </TooltipProvider>
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Button
                                                ...
                                                className="h-auto w-auto p-1.5 hover:bg-red-500/10 text-muted-foreground hover:text-red-500 rounded-md transition-colors"
                                            >
