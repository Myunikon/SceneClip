export const id = {
    ...
    settings: {
        ...
        downloads: {
            ...
            quick_mode_desc: "Gunakan pengaturan terakhir untuk unduh langsung tanpa dialog",
            storage: "Penyimpanan",
        ...
        network: {
            ...
            proxy: "URL Proxy",
            user_agent: "Aktifkan Imposter Mode (User Agent)",
            ua_desc: "Menyamar sebagai Chrome untuk hindari error 429.",
        ...
        advanced: {
            ...
            errors: {
                ...
                access_desc: "Izin ditolak oleh sistem.",
                folder_not_found: "Folder Tidak Ditemukan",
                folder_desc: "Direktori sudah tidak ada.",
                file_desc: "File mungkin sudah dipindah atau dihapus.",
                open_folder: "Buka Folder"
            },
            video_processing: {
    ...
    guide: {
        ...
        steps: {
            ...
            perf: {
                ...
                desc: "Laptop lambat? Nyalakan 'Low Performance Mode' (Ikon Petir)."
            },
            terminal: {
                title: "Terminal & Log",
    ...
    statusbar: {
      ...
      available: "kosong"
        ...
        errors: {
            system_action: "Gagal menjalankan aksi sistem: {action}",
            listener_attach: "Gagal memasang pendengar unduhan",
            binary_validation: "Validasi binary gagal",
            update_check: "Gagal memeriksa pembaruan",
            binary_crash: "Kesalahan Binary Kritis",
