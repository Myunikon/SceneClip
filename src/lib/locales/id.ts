export const id = {
    ...
    settings: {
        ...
        general: {
            ...
            launch_startup_desc: "Jalankan otomatis saat masuk sistem",
            start_minimized: "Mulai diminimalkan ke Tray",
            start_minimized_desc: "Mulai di latar belakang (System Tray)",
        ...
        quality: {
            ...
            embed_metadata_desc: "Tulis tag metadata ke file video",
            embed_thumbnail: "Sematkan Thumbnail",
            embed_thumbnail_desc: "Pasang thumbnail dari sumber",
            embed_chapters: "Sematkan Bab Video",
            embed_chapters_desc: "Tambahkan penanda bab ke file",
        ...
        advanced: {
            ...
            content_enhancements: {
                ...
                srt_fixer: "SRT Fixer",
                srt_fixer_desc: "Perbaiki baris ganda dan waktu tumpang tindih pada subtitle otomatis YouTube.",
                smart_proxy: "Smart Proxy Rotator",
                smart_proxy_desc: "Otomatis ganti proxy untuk menghindari blokir IP (HTTP 429).",
