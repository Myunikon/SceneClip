export const ms = {
    ...
    settings: {
        ...
        general: {
            ...
            launch_startup_desc: "Lancarkan secara automatik semasa log masuk",
            start_minimized: "Mula diminimimumkan ke Tray",
            start_minimized_desc: "Mula di latar belakang (System Tray)",
        ...
        quality: {
            ...
            embed_metadata_desc: "Tulis tag metadata ke fail video",
            embed_thumbnail: "Benamkan Gambar Kecil",
            embed_thumbnail_desc: "Tetapkan gambar kecil dari sumber",
            embed_chapters: "Benamkan Bab Video",
            embed_chapters_desc: "Tambah penanda bab ke fail",
